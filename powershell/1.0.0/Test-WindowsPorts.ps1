...
function Test-ServerRolePortGroup {
	...
	begin {
		$PortGroups = @{
			...
			'Smb' = @{ 'TCP' = 445; 'UDP' = 445 }
			'Dns' = @{ 'TCP' = 53; 'UDP' = 53 }
			'ActiveDirectoryGeneral' = @{ 'TCP' = 88, 389, 464, 636, 5722, 9389; 'UDP' = 88,123,389,464 }
...
Test-ServerRolePortGroup -ComputerName $Computernames -ServerRole Smb, Dns, ActiveDirectoryGeneral, ActiveDirectoryGlobalCatalog, NetBios